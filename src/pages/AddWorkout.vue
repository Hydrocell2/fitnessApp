    ...
    <div class="form-wrapper">
        <div class="form-container">
            <div class="form-header">
                <i class="bi bi-plus-circle-fill form-icon"></i>
                <h1>Add New Workout</h1>
                <p class="form-subtitle">Create a workout plan to track your progress</p>
            </div>
            ...
            <form @submit.prevent="addWorkout">
                ...
                <div class="form-actions">
                    <button :disabled="!isActive" type="submit" class="btn btn-primary" :class="{'btn-disabled': !isActive}">
                        <i class="bi bi-check-circle me-2"></i>Add Workout
                    </button>
...
function addWorkout() {
    ...
    axios.post('/workouts/addWorkout', {
        name: name.value,
